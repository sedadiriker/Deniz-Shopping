...
>
  <Box   sx={{
    ...
    <Card sx={{height:550, width:'100%',margin:'auto', position: 'relative', borderRadius: '10px', boxShadow: '1px 2px 40px black' }}>
        <CardActionArea>
          ...
          <CardContent>
            <Typography textAlign={'center'} gutterBottom fontSize="1.5rem" sx={{color:'brown'}} variant="h5" component="div">
              {title}
            </Typography>
          </CardContent>
        </CardActionArea>
        <Typography px={1} pb={5} fontSize={14} sx={{ position: 'absolute', bottom: '2px', left: '10px', color: 'black' }}>{description} </Typography>
        <CardActions>
